...
if TYPE_CHECKING:  # pragma: no cover
    from pydicom_v3_0_1.dataelem import RawDataElement
...
#    default False; was decimal-based in pydicom_v3_0_1 0.9.7
...
import pydicom_v3_0_1.pixel_data_handlers.numpy_handler as np_handler  # noqa
import pydicom_v3_0_1.pixel_data_handlers.rle_handler as rle_handler  # noqa
import pydicom_v3_0_1.pixel_data_handlers.pillow_handler as pillow_handler  # noqa
import pydicom_v3_0_1.pixel_data_handlers.jpeg_ls_handler as jpegls_handler  # noqa
import pydicom_v3_0_1.pixel_data_handlers.gdcm_handler as gdcm_handler  # noqa
import pydicom_v3_0_1.pixel_data_handlers.pylibjpeg_handler as pylibjpeg_handler  # noqa
...
def future_behavior(enable_future: bool = True) -> None:
    ...
    ----------
    enable_future: bool
        Set ``True`` (default) to emulate future pydicom_v3_0_1 behavior,
        ``False`` to reset to current pydicom_v3_0_1 behavior.
