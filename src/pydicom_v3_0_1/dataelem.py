...
from pydicom_v3_0_1 import config  # don't import datetime_conversion directly
...
from pydicom_v3_0_1.hooks import hooks
from pydicom_v3_0_1.jsonrep import JsonDataElementConverter, BulkDataType
from pydicom_v3_0_1.misc import warn_and_log
from pydicom_v3_0_1.multival import MultiValue
from pydicom_v3_0_1.tag import Tag, BaseTag, _LUT_DESCRIPTOR_TAGS
from pydicom_v3_0_1.uid import UID
from pydicom_v3_0_1 import jsonrep
from pydicom_v3_0_1.fileutil import check_buffer, buffer_length, buffer_equality
import pydicom_v3_0_1.valuerep  # don't import DS directly as can be changed by config
...
class DataElement:
    ...
    validation_mode : int
        ...
        <pydicom_v3_0_1.config.Settings.writing_validation_mode>` for more information.
    VR : str
