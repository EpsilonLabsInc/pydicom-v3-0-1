...
or import and use specific functions to provide code for pydicom_v3_0_1 DICOM classes
...
from pydicom_v3_0_1.datadict import dictionary_keyword
from pydicom_v3_0_1.dataelem import DataElement
from pydicom_v3_0_1.dataset import Dataset
from pydicom_v3_0_1.tag import BaseTag
from pydicom_v3_0_1.valuerep import BYTES_VR, AMBIGUOUS_VR, VR
from pydicom_v3_0_1.cli.main import filespec_help, filespec_parser
...
def code_imports() -> str:
    ...
    line2 = "from pydicom_v3_0_1.dataset import Dataset, FileMetaDataset"
    line3 = "from pydicom_v3_0_1.sequence import Sequence"
...
def code_file_from_dataset(
    ...
    ----------
    ds : Dataset
        A pydicom_v3_0_1 Dataset to convert
    exclude_size : int |None
        If not None, values longer than this (in bytes)
        will only have a commented string for a value,
        causing a syntax error when the code is run,
    ...
    lines.append("# Produced by pydicom_v3_0_1 codify utility script")
