...
from pydicom_v3_0_1.datadict import _dictionary_vr_fast
...
from pydicom_v3_0_1.filebase import ReadableBuffer, DicomBytesIO
...
from pydicom_v3_0_1.misc import size_in_bytes, warn_and_log
from pydicom_v3_0_1.sequence import Sequence
from pydicom_v3_0_1.tag import (
    ItemTag,
...
from pydicom_v3_0_1.util.hexutil import bytes2hex
from pydicom_v3_0_1.valuerep import EXPLICIT_VR_LENGTH_32, VR as VR_
...
def data_element_generator(
    ...
    #    data element
    from pydicom_v3_0_1.values import convert_string
...
def read_partial(
    ...
    if peek == b"":  # EOF
        ...
        from pydicom_v3_0_1.values import converters
...
def read_deferred_data_element(
    ...
    .. note:
        ...
        This is called internally by pydicom_v3_0_1 and will normally not be
        needed in user code.
