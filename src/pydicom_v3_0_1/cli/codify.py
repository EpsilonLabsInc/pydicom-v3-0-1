...
import pydicom_v3_0_1.util.codify
...
def add_subparser(subparsers: argparse._SubParsersAction) -> None:
    codify_parser = subparsers.add_parser(
        "codify",
        description=(
            "Read a DICOM file and produce the pydicom_v3_0_1 (Python) "
    ...
    pydicom_v3_0_1.util.codify.set_parser_arguments(codify_parser, default_exclude_size)
    codify_parser.set_defaults(func=pydicom_v3_0_1.util.codify.do_codify)
